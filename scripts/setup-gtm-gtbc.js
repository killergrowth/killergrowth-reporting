/**
 * setup-gtm-gtbc.js
 * Sets up full conversion tracking in GTM-WQWXWSB9 for Good To Be Clean
 * GA4 Measurement ID: G-W2T4Y5KF1P
 *
 * Conversions:
 ...
 *
 * Usage: node scripts/setup-gtm-gtbc.js
 */
...
const ACCOUNT_ID   = '6313512390';
const CONTAINER_ID = '230246449';
const GA4_ID       = 'G-W2T4Y5KF1P';
...
async function createWorkspace() {
  ...
  const ws = await req('POST', `/accounts/${ACCOUNT_ID}/containers/${CONTAINER_ID}/workspaces`, {
    ...
    description: 'phone_click, generate_lead, cta_click, email_click, scroll_depth — added by Phil Jr 2026-08-06'
  });
...
async function main() {
  ...
  console.log('\n✅ Done — GTM-WQWXWSB9 fully set up and published.');
  console.log('Next: mark phone_click + generate_lead as conversions in GA4 (G-W2T4Y5KF1P).');
}
